export const metadata = {
  title: 'Document Key-Value Extraction + RAG - Superduper',
...
import HeroAIStack from '@/components/hero-ai-stack'
import FeaturesAIStack from '@/components/features-ai-stack'
