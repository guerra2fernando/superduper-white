          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-center flex-wrap items-center">
              <li className="relative group">
                <Link
                  className="font-medium text-sm text-slate-600 hover:text-slate-800 px-4 py-2 mx-4 lg:mx-5 transition duration-150 ease-in-out"
                  href="#"
                >
                  Solutions
                </Link>
                <ul className="absolute left-1/2 transform -translate-x-1/2 mt-1 bg-slate-900 rounded shadow-lg min-w-[140px] opacity-0 group-hover:opacity-100 group-hover:visible invisible transition-opacity duration-300 ease-in-out">
