        ...
        <div className="max-w-xl lg:max-w-6xl mx-auto px-4 sm:px-6">
          <div className="lg:flex space-y-12 lg:space-y-0 lg:space-x-12 xl:space-x-24">
            ...
            <div className="lg:max-w-none lg:min-w-[524px]">
              ...
              <div className="mb-8 md:mb-0 space-y-2">
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">Direct data access</div>
                    <div className="text-zinc-500">Installation of any model and API directly on your databases; input and training data definition with database queries. </div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">Streaming inference</div>
                    <div className="text-zinc-500">Real time processing of new incoming data keeping your AI applications up-to-date instantly and immediately.</div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">Model training/fine-tuning</div>
                    <div className="text-zinc-500">on your data without without additional pre-processing and data ingestion.</div>
                  </div>
                </button>
              </div>
            </div>
            ...
            <div className="relative lg:max-w-none">
              ...
              {/* Gear illustration */}
              <Image className="absolute left-0 bottom-0 -translate-x-1/2 translate-y-1/3  max-lg:w-32" src={FeatureIllustration} alt="Features 02 illustration" width={173} height={167} aria-hidden="true" />
            </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-16">
            ...
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">AI outputs in your database</h3>
              </div>
              <p className="text-sm text-zinc-500">Organized and available for downstream applications and your teams.</p>
            </div>
            {/* Block #2 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Compatible & Open</h3>
              </div>
              <p className="text-sm text-zinc-500">Leverage any AI + Python package and major AI frameworks, tools and libraries to enhance your applications.</p>
            </div>
            {/* Block #3 */}
            <div>
              <div className="flex items-center mb-1">
                ...
                <h3 className="font-inter-tight font-semibold text-zinc-200">Support of any data type</h3>
              </div>
              <p className="text-sm text-zinc-500"> Store, retrieve and work with images, video, audio in your database, and any type which can be encoded as bytes in Python. </p>
            </div>
            {/* Block #4
            <div>
              <div className="flex items-center mb-1">
